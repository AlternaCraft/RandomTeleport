 ...
 * @author Julián
 */
public class PurgeCommandExecutor
    implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String cmdLabel, String args[])
    {
        ...
        try {
            conf.save("plugins/RandomTeleport/config.yml");
            plugin.reloadConfig();
            sender.sendMessage(PLUGIN + ChatColor.GOLD + "Plugin limpiado correctamente");
        } catch (IOException ex) {
            sender.sendMessage(PLUGIN + ChatColor.RED + "No se ha podido purgar la configuracion");
        }       
        return true;
    }
}
